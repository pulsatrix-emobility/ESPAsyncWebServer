...
const char * AsyncWebServerRequest::methodToString() const {
  ...
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_GET)) return "GET";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_POST)) return "POST";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_DELETE)) return "DELETE";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_PUT)) return "PUT";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_PATCH)) return "PATCH";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_HEAD)) return "HEAD";
  else if(static_cast<int>(_method) & static_cast<int>(WebRequestMethod::HTTP_OPTIONS)) return "OPTIONS";
  return "UNKNOWN";
}
